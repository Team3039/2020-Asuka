...
import static edu.wpi.first.wpilibj.smartdashboard.SendableRegistry.addChild;
import static edu.wpi.first.wpilibj.smartdashboard.SendableRegistry.setName;
...
public class BHRDifferentialDrive extends RobotDriveBase {
  ...
  public BHRDifferentialDrive(SpeedController leftMotor, SpeedController rightMotor) {
    ...
    addChild(parent, m_leftMotor);
    addChild(parent,m_rightMotor);
    instances++;
    setName(parent,"DifferentialDrive", instances);
  }
