...
const fieldWidth = 624.95; // inches //650.25
const fieldHeight = 324; // inches //322.5
const xOffset = 0;
const yOffset = 162;
const width = 1683; //pixels
const height = 871; //pixels

const robotWidth = 29; // inches
const robotHeight = 29; // inches
