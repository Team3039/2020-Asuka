package com.team3039.frc2020.paths;
...
public class TrajectoryGeneratorTest {
        ...
        public void test() {
                ...
                LazyLoadTrajectory centerStartToEndOfTrench = TrajectoryGenerator.getInstance()
                                .getTrajectorySet().centerStartToEndOfTrench;
                centerStartToEndOfTrench.activate();
                verifyMirroredTrajectories(centerStartToEndOfTrench.getTrajectory(), false);

                LazyLoadTrajectory driveStraightReversed = TrajectoryGenerator.getInstance()
                                .getTrajectorySet().driveStraightReversed;
                driveStraightReversed.activate();
                verifyMirroredTrajectories(driveStraightReversed.getTrajectory(), true);
